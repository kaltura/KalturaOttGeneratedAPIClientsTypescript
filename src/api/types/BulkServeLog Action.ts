...
export interface BulkServeLog ActionArgs  extends KalturaRequestArgs {
    id : number;
}
 ...
 */
export class BulkServeLog Action extends KalturaRequest<KalturaBulk> {

    id : number;

    constructor(data : BulkServeLog ActionArgs)
    {
