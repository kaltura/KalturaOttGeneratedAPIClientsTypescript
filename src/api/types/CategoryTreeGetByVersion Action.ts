...
export interface CategoryTreeGetByVersion ActionArgs  extends KalturaRequestArgs {
    versionId? : number;
}
 ...
 */
export class CategoryTreeGetByVersion Action extends KalturaRequest<KalturaCategoryTree> {

    versionId : number;

    constructor(data? : CategoryTreeGetByVersion ActionArgs)
    {
